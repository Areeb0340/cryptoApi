...
from market_data.models import Coin, LongShortRatio
...
class Command(BaseCommand):
    ...
    help = "Sync Binance Global Long Short Ratio"
    ...
    def handle(self, *args, **kwargs):
            ...
            for timeframe in TIMEFRAMES:
                ...
                try:
                    ...
                    for item in data:
                        ...
                        LongShortRatio.objects.update_or_create(
        ...
        self.stdout.write(
            ...
            self.style.SUCCESS(
                ...
                f"\n🎉 Finished! {total} Long/Short records synced."
